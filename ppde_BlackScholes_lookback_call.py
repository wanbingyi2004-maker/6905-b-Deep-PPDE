...
from lib.options import LookbackCall
...
def train(T,
    ...
    ax.legend()
    fig.savefig(os.path.join(base_dir, "BS_lookback_call_LSTM_sol.pdf"))
...
if __name__ == "__main__":
    ...
    results_path = os.path.join(args.base_dir, "BS_lookback_call", args.method)
